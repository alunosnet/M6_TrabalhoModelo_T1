<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="melhor_aluno.aspx.cs" Inherits="M6_TrabalhoModelo_T1.Consultas.melhor_aluno" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <asp:SqlDataSource runat="server" ID="SqlMelhor" ConnectionString='<%$ ConnectionStrings:ConnectionStringNotas %>' SelectCommand="SELECT TOP (1) alunos.nome, AVG(notas.valor_nota) AS Média FROM alunos INNER JOIN notas ON alunos.nprocesso = notas.nprocesso GROUP BY notas.nprocesso, alunos.nome ORDER BY Média DESC"></asp:SqlDataSource>
        </div>
    </form>
        <!--JS-->
