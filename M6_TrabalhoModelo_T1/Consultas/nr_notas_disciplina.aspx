<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nr_notas_disciplina.aspx.cs" Inherits="M6_TrabalhoModelo_T1.Consultas.nr_notas_disciplina" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlNotas_Disciplinas">
                <AlternatingItemTemplate>
                    <tr style="">
                        <td>
                            <asp:Label Text='<%# Eval("nome") %>' runat="server" ID="nomeLabel" /></td>
                        <td>
                            <asp:Label Text='<%# Eval("Contar") %>' runat="server" ID="ContarLabel" /></td>
                    </tr>
                </AlternatingItemTemplate>
                <EditItemTemplate>
                    <tr style="">
                        ...
                        <td>
                            <asp:TextBox Text='<%# Bind("Contar") %>' runat="server" ID="ContarTextBox" /></td>
                    </tr>
                </EditItemTemplate>
                <EmptyDataTemplate>
            ...
            <asp:SqlDataSource runat="server" ID="SqlNotas_Disciplinas" ConnectionString='<%$ ConnectionStrings:ConnectionStringNotas %>' SelectCommand="SELECT disciplinas.nome, COUNT(*) AS Contar FROM disciplinas INNER JOIN notas ON disciplinas.codigo = notas.codigo_disciplina GROUP BY notas.codigo_disciplina, disciplinas.nome"></asp:SqlDataSource>
        </div>
    </form>
        <!--JS-->
